...
CREATE TABLE USER_CURRENT_CITIES (
    ...
    CONSTRAINT PK_CURRENT_CITIES PRIMARY KEY (USER_ID, CURRENT_CITY_ID)
);
CREATE TABLE USER_HOMETOWN_CITIES (
    ...
    CONSTRAINT PK_HOMETOWN_CITIES PRIMARY KEY (USER_ID, HOMETOWN_CITY_ID)
);
...
CREATE TABLE ALBUMS (
    ...
    CONSTRAINT FK_ALBUMS_PHOTO FOREIGN KEY (COVER_PHOTO_ID) REFERENCES PHOTOS(PHOTO_ID),
