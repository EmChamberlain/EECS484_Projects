...
(SELECT DISTINCT USER1_ID AS COL1, USER2_ID AS COL2 FROM jsoren.PUBLIC_ARE_FRIENDS
UNION
SELECT DISTINCT USER2_ID AS COL1, USER1_ID AS COL2 FROM jsoren.PUBLIC_ARE_FRIENDS)
WHERE COL1 < COL2;
